        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="bg-white p-6 rounded-xl shadow-lg">
              ...
              <p className="text-3xl font-bold text-blue-600">{stats.totalAccuracy.toFixed(1)}%</p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg">
              <h3 className="text-lg font-semibold text-gray-600 mb-2">Squares Mastered</h3>
              <p className="text-3xl font-bold text-blue-600">{stats.masteredSquares}/64</p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg">
              <h3 className="text-lg font-semibold text-gray-600 mb-2">Current Streak</h3>
              <p className="text-3xl font-bold text-blue-600">{dailyStreak} days</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {/* Heatmap */}
            <div className="bg-white p-6 rounded-xl shadow-lg">
              <h2 className="text-xl font-semibold mb-4">Square Accuracy Heatmap</h2>
